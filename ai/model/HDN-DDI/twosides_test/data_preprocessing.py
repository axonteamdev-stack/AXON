...
PKL_FILE = os.path.join(_BASE_DIR, "Twosides", "id_data_dict_dsn_full_connect.pkl")
SMILES_FILE = os.path.join(_BASE_DIR, "Twosides", "drug_smiles.csv")
DDI_FILE = os.path.join(_BASE_DIR, "Twosides", "ddis.csv")
    ...
    def __init__(self, tri_list, shuffle=True):
        ...
        for h, t, r, n in tri_list:
            if (
                ...
                and (n in MOL_EDGE_LIST_FEAT_MTX)
            ):
    ...
    def collate_fn(self, batch):
        ...
        for h, t, r, n in batch:
            ...
            neg_b_graph = self._create_b_graph(
                get_bipartite_graph(h_data, n_data), h_data.x, n_data.x
            )
