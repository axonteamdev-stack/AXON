...
df_ddi_train = pd.concat([
    pd.read_csv(os.path.join(_BASE_DIR, 'DrugBank', 'cold_start', f'fold{args.fold}', 'train.csv')),
    pd.read_csv(os.path.join(_BASE_DIR, 'DrugBank', 'cold_start', f'fold{args.fold}', 'val.csv'))
], axis=0)
df_ddi_s1 = pd.read_csv(os.path.join(_BASE_DIR, 'DrugBank', 'cold_start', f'fold{args.fold}', 's1.csv'))
df_ddi_s2 = pd.read_csv(os.path.join(_BASE_DIR, 'DrugBank', 'cold_start', f'fold{args.fold}', 's2.csv'))
...
model = models.HDN_DDI(n_atom_feats, n_atom_hid, kge_dim, rel_total, heads_out_feat_params=[64,64,64,64,64,64], blocks_params=[2, 2, 2, 2, 2, 2])
...
test_model = models.HDN_DDI(n_atom_feats, n_atom_hid, kge_dim, rel_total, heads_out_feat_params=[64,64,64,64,64,64], blocks_params=[2, 2, 2, 2, 2, 2])
