...
df_ddi_train = pd.read_csv(os.path.join(_BASE_DIR, 'DrugBank', 'warm_start', f'fold{args.fold}', 'train.csv'))
df_ddi_test = pd.read_csv(os.path.join(_BASE_DIR, 'DrugBank', 'warm_start', f'fold{args.fold}', 'test.csv'))
