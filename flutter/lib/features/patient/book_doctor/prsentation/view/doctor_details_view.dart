      ...
      Container(
        ...
        child: CircleAvatar(
          ...
          backgroundImage: AssetImage(doctor.image),
                  ...
                  TextApp(
                    text:
                        '${doctor.yearsOfExperience} ${context.l10n.years_experience}',
                    fontSize: 12,
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: 8.w),
                        TextApp(
                          text: context.l10n.about_doctor,
                          fontSize: 15,
                          weight: AppTextWeight.bold,
                        ),
                      ],
                    ...
                    TextApp(
                      text: context.l10n.patient_reviews,
                      fontSize: 15,
                      weight: AppTextWeight.bold,
                    ),
