  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          CustomAppBar(
            title: context.l10n.chat_bot_title,
            trailing: Image.asset(AppImages.chatBot, width: 45.w, height: 45.w),
          ),
          Expanded(
              ...
              builder: (context, state) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    final isMe = msg.type == MessageType.user;
                    final isWelcome = msg.type == MessageType.bot && index == 0;
                    return Align(
                      alignment: isMe
