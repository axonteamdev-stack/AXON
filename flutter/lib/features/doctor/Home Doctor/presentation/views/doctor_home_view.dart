...
class DoctorHomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => getIt<DoctorHomeCubit>()..loadDoctorHome(),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: state.currentTab == DoctorHomeTab.requests
                            ? state.requestPatients.isEmpty
                                  ? ListView(
                                      children: [
                                  ...
                                  : ListView.separated(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return DoctorRequestCard(
                                          ...
                                          notes: patient.notes,
                                          image:
                                              "${Endpoints.baseUrlImage}${patient.patientImage}",
                                          onAccept: () {
                                            context
                                                .read<DoctorHomeCubit>()
                                                .acceptRequest(
                            ...
                            : ListView.separated(
                                ...
                                itemBuilder: (_, index) {
                                  ...
                                  return DoctorChatCard(
                                    ...
                                    image:
                                        "${Endpoints.baseUrlImage}${patient.image}",
                                  );
                                },
                              ),
                      ),
