...
/**
 * 4. تصدير موحد - كائن واحد يحتوي على جميع أنواع Upload المطلوبة
 * استخدم هذا الكائن في جميع المسارات
 */
const uploadMiddleware = {
  ...
  post: upload.fields([{ name: "postImage", maxCount: 1 }]),
